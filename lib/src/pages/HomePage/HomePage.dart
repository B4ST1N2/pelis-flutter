      ...
      child: Scaffold(
        appBar: AppBar(
          backgroundColor: Color.fromARGB(
              255, 228, 211, 64), // Define el color de fondo del AppBar.
          title:
              const Text('IMBXD'), // Título centrado que aparece en el AppBar.
          ...
          bottom: const TabBar(
            ...
            tabs: [
              Tab(
                  icon: Icon(Icons
                      .movie)), // Primera pestaña con un icono de película.
              Tab(
                  icon: Icon(
                      Icons.tv)), // Segunda pestaña con un icono de televisión.
              Tab(
                  icon: Icon(
                      Icons.topic)), // Tercera pestaña con un icono de tema.
            ],
          ),
        ),
